    ...
    def __init__(
        ...
        **kwargs,
        ...
        if mode == FactoryMode.Entries:
            ...
            plot.__name__ = "plot"
            plot.__module__ = Indicator.__module__
            plot.__qualname__ = f"{Indicator.__name__}.{plot.__name__}"
    ...
    def with_place_func(
        ...
        **kwargs,
        ...
        apply_func.__doc__ = inspect.cleandoc(
            """
            Apply the selected placement/generation function(s) for a single parameter combination.

            This function is dynamically generated by `vectorbtpro.signals.factory.SignalFactory.with_place_func`
            and its exact signature depends on the factory `mode` and the function settings.
            """
        )
        ...
        custom_func.__doc__ = custom_func.__doc__.format(
            ...
            Indicator.__name__ + ".entry_place_func_nb" if entry_place_func_nb is not None else "entry_place_func_nb",
            Indicator.__name__ + ".exit_place_func_nb" if exit_place_func_nb is not None else "exit_place_func_nb",
        )
